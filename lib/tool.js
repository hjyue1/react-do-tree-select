...
// 把条目加入数组中并去重
var addArrayItem = exports.addArrayItem = function addArrayItem(arr, node) {
...
// 生成IdList
// export const generateIdList = (treeData, TreeDataMap, _idList = []) => {
//     const idList = _idList
//     treeData.forEach((item) => {
//         if (TreeDataMap[item.value].isExpand) {
//             idList.push(item.value)
//         }

//         if (!isEmptyArray(item.children)) {
//             generateIdList(item.children, TreeDataMap, idList)
//         }
//     })
//     return idList
// }
...
var getFilterIdList = exports.getFilterIdList = function getFilterIdList(idList, treeDataMap, val) {
    ...
    idList.forEach(function (item) {
        var _treeDataMap$item2 = treeDataMap[item],
            ...
            isExpand = _treeDataMap$item2.isExpand;
