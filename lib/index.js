...
var TreeSelect = function (_Component) {
    ...
    _createClass(TreeSelect, [{
            ...
            if (prevState.treeData != this.state.treeData) {
                ...
                if (!(0, _tool.isEmptyArray)(initCheckedList)) {
                    initCheckedList.forEach(function (_item) {
                        treeDataMap[_item] && _this2.onChecked(treeDataMap[_item]);
                    });
                }
            }
        }
            ...
            if (isExpand) {
                ...
                if (!(0, _tool.isEmptyArray)(item.children)) {
                    ...
                    arr.forEach(function (_item) {
                        ...
                        (0, _tool.delArrayItem)(_renderIdList, _item);
                    });
                }
            }
        ...
        value: function onChecked(item, e) {
            ...
            var _checkedList = checkedList.concat([]);

            // 处理勾选的value List
            if (_checked) {
                _checkedList.push(value);
            } else {
                (0, _tool.delArrayItem)(_checkedList, value);
            }
            ...
            _treeDataMap[value] = _extends({}, _treeDataMap[value], {
                ...
                // 处理复选框联动逻辑
            });_checkbox.parentChain && (0, _tool.parentChain)(_treeDataMap, _treeDataMap[item.parentVal], _checkbox, _checkedList);
            _checkbox.childrenChain && (0, _tool.childrenChain)(_treeDataMap, item.children, _checked, _checkedList);
            this.setState({
                treeDataMap: _treeDataMap,
                checkedList: _checkedList,
                updateListState: !updateListState
            }, function () {
                e && onChecked && onChecked(_this3.state.checkedList, e);
            });
        }
        ...
        value: function treeNodeRender(_ref) {
            ...
            var _props2 = this.props,
                ...
                customIconRender = _props2.customIconRender,
                customTitleRender = _props2.customTitleRender;
            ...
            return _react2.default.createElement(
                ...
                {
                    key: item.value,
                    style: _extends({}, _style, { width: 'auto' }),
                    onClick: function onClick(e) {
                        return _this4.onClickRow(item, e);
                    },
                ...
                _react2.default.createElement(
                    ...
                    _checkbox.enable && _react2.default.createElement(
                        'div',
                        { onClick: function onClick(e) {
                                return _this4.onChecked(item, e);
                            }, className: prefixClassName + '-checkbox ' + checkedClassName + ' ' + halfCheckedClassName },
                        _react2.default.createElement('span', { className: prefixClassName + '-checkbox-inner ' + (disabled ? 'disabled' : '') })
                    ),
                    _react2.default.createElement(
                        'div',
                        { title: item.title, className: prefixClassName + '-title ' + (isSelectVal ? 'active' : '') },
        ...
        value: function onSearch(val) {
            ...
            _filterIdList = (0, _tool.treeDataMapCheckRenderIdList)(_filterIdList);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: _className, style: { width: _style.width } },
                _react2.default.createElement(_searchBox2.default, { defaultProps: defaultProps, searchVal: searchVal, onSearch: this.onSearch }),
                _react2.default.createElement(
                    'div',
                    { className: prefixClassName + '-TreeSelectList', style: _extends({}, _style, { overflow: 'unset' }) },
