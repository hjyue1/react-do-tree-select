    ...
    _createClass(TreeSelect, [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            ...
            if (nextProps.treeData !== prevState.treeData) {
                var initCheckedList = new Map(defaultConfig.checkbox.initCheckedList.map(function (item) {
                    return [item.toString(), item.toString()];
                }));

                var _generateTreeDataMap = (0, _tool.generateTreeDataMap)({}, nextProps.treeData, defaultConfig, initCheckedList, prevState.checkedList),
                ...
                (0, _tool.checkedCheckedList)(map, checkedList, defaultConfig.checkbox);
